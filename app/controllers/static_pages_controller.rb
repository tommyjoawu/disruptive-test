class StaticPagesController < ApplicationController
  ...
  def home
    test_key = GlobalParameter.find_by(code: "coinapi").value
    ...
    @exchange_rates = []
    @exchange_rates << btc_x_usd_exchange_rate = api.exchange_rates_get_specific_rate(asset_id_base: 'BTC',
                                                           asset_id_quote: 'USD')

    @exchange_rates << ada_x_usd_exchange_rate = api.exchange_rates_get_specific_rate(asset_id_base: 'ADA',
                                                           asset_id_quote: 'USD')

    @exchange_rates << eth_x_usd_exchange_rate = api.exchange_rates_get_specific_rate(asset_id_base: 'ETH',
                                                           asset_id_quote: 'USD')
    
    


    @assets = [{:asset_id=>"YUKKY",
    :name=>"YUKKY",
    :type_is_crypto=>true,
